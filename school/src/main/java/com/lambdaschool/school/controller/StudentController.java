...
public class StudentController
{
    ...
    @ApiOperation(value = "return student by id", response = Student.class)
    @ApiResponses(value={
    ...
    @ApiOperation(value = "add student", notes = "The newly created student id will be sent in the location header",
    response = void.class)
    @ApiResponses(value={
